...
you jump to the index j such that A[i] <= A[j] and A[j]
...
you can reach the end of the array (index A.length - 1) 
...
(since A[2] is the smallest among A[1], A[2], A[3], A[4] 
...
is the smallest value in (A[1], A[2], A[3], A[4]) that is greater than or equal to A[0].
...
In total, there are 3 different starting indexes 
(i = 1, i = 3, i = 4) where we can reach the end with some number of jumps.
...
const arr1 = [10,13,12,14,15]
console.log(oddEvenJumps(arr1))
console.log("Output: 2")
console.log(" ")

const arr2 = [5,1,3,4,2]
console.log(oddEvenJumps(arr2))
console.log("Output: 3")
console.log(" ")

const arr3 = [2,3,1,1,4]
console.log(oddEvenJumps(arr3))
console.log("Output: 3")
